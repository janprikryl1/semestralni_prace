...
def setup_logging(logging_config: dict, symbol: str = "", base_dir: Path = None, console_output: bool = False):
    logs_dir_name = logging_config.get("log_dir", "logs")
    logs_dir = (base_dir / logs_dir_name) if base_dir else Path(logs_dir_name)
