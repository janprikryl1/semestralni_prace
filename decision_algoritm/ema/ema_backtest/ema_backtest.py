...
Vyžaduje: ta-lib (stejná závislost jako ema/ema_fear_greed_talib)
...
# ---------------------------------------------------------------------------
# Parametry strategie — přesně z ema/ema_fear_greed_talib/config.json
# ---------------------------------------------------------------------------
EMA_PERIOD = 21
...
def backtest_coin(df: pd.DataFrame, fear_greed: dict, symbol: str) -> dict:
    ...
    for i in range(start_idx, len(closes)):
        ...
        # Signál — přesná logika z ema/ema_fear_greed_talib/main.py
        signal = "HOLD"
